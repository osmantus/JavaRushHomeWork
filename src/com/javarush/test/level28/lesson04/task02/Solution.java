...
public class Solution {
    public static int getRandomIntegerBetweenNumbers(int from, int to) throws IllegalArgumentException {

        return ThreadLocalRandom.current().nextInt(from, to);
    }

    public static double getRandomDouble() throws IllegalArgumentException {

        return ThreadLocalRandom.current().nextDouble();
    }

    public static long getRandomLongBetween0AndN(long n) throws IllegalArgumentException {
