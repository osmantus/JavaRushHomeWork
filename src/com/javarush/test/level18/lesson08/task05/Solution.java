...
public class Solution {
    public class TableInterfaceWrapper implements ATableInterface {
        ...
        ATableInterface innerObj;

        public TableInterfaceWrapper(ATableInterface innerObj)
        {
        ...
        public void setModel(List rows)
        {
            ...
            innerObj.setModel(rows);
        }

        @Override
        public String getHeaderText()
        {
            return innerObj.getHeaderText().toUpperCase();
        }

        @Override
        public void setHeaderText(String newHeaderText)
        {
            innerObj.setHeaderText(newHeaderText);
        }
    }
