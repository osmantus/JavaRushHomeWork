...
public class Solution {
    ...
    public static void main(String[] args) throws Throwable
    {
        ...
        strings.addAll(solution.readFileContent("D:\\Work\\Java\\L21Les10T3\\FakeFileName.txt"));
        strings.addAll(solution2.readFileContent("D:\\Work\\Java\\L21Les10T3\\FakeFileName2.txt"));
        System.out.println("Count of strings is " + strings.size());
    }

    public List<String> readFileContent(String path) throws Throwable
    {
        List<String> strings = new ArrayList<>();
    ...
    public static class Utilizator {
        ...
        public void dispose() {
            ...
            {
                //util.sout("It`s impossible to dispose resources!");
            }
        }
    }
