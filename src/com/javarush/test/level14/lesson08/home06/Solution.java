...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        String inputTxt = "";
        Movie abstractMovie = null;

        while (true)
        {
            inputTxt = reader.readLine();
            if (!inputTxt.equals("cartoon") && !inputTxt.equals("thriller") && !inputTxt.equals("soapOpera"))
            {
                break;
                //abstractMovie = MovieFactory.getMovie(inputTxt);
                //System.out.println(abstractMovie.getClass().getSimpleName());
            }
            /*else if (inputTxt.equals("thriller"))
                abstractMovie = MovieFactory.getMovie(inputTxt);
            else if (inputTxt.equals("soapOpera"))
                abstractMovie = MovieFactory.getMovie(inputTxt);*/
            else
            {
                abstractMovie = MovieFactory.getMovie(inputTxt);
