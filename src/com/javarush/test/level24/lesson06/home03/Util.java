...
public class Util {
    ...
    public static List<Jeans> getAllJeans() {
        ...
        abstract class AbstractJeans implements Jeans
        {
            ...
            {
                String result = null;
                result = this.getClass().getSimpleName().concat("{");
                result = result.concat("id=".concat(String.valueOf(id)));
                result = result.concat(", ");
                result = result.concat("length=".concat(String.valueOf(length)));
                result = result.concat(", ");
                result = result.concat("size=".concat(String.valueOf(size)));
                result = result.concat(", ");
                result = result.concat("price=".concat(String.valueOf(price)));
                result = result.concat("}");
                return result;
            }
        }
