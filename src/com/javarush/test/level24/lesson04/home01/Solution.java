...
public class Solution {
    ...
    public static class Rectangle {
        ...
        public HasHeight castToHasHeight() {
            class HasHeightNew implements HasHeight
            {
                @Override
            ...
            HasHeightNew hasHeight = new HasHeightNew();
            return hasHeight;
        }

        public HasWidth castToHasWidth() {
            class HasWidthNew implements HasWidth
            {
                @Override
            ...
            HasWidthNew hasWidth = new HasWidthNew();
            return hasWidth;
        }
    }
}
