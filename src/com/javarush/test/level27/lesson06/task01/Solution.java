...
public class Solution {
    public void safeMethod(Object obj1, Object obj2) {
        ...
        Object firstObjToLock = obj1.hashCode() > obj2.hashCode() ? obj2 : obj1;
        Object secondObjToLock = obj1.hashCode() > obj2.hashCode() ? obj1 : obj2;

        synchronized (firstObjToLock) {
            longTimeMethod();
            synchronized (secondObjToLock) {
