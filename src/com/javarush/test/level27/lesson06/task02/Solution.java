...
public class Solution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    if (isNormalLockOrder(solution, o1, o2)) //expected boolean b
                        System.out.println(Thread.currentThread().getName() + ": o1, o2 - true");
                    else
                        System.out.println(Thread.currentThread().getName() + ": o1, o2 - false");
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    if (isNormalLockOrder(solution, o2, o1)) //expected boolean !b
                        System.out.println(Thread.currentThread().getName() + ": o2, o1 - true");
                    else
                        System.out.println(Thread.currentThread().getName() + ": o2, o1 - false");
                } catch (Exception ignored) {
                }
            }
        }.start();
